...
- **Diagram archetypes**: `topology` (cluster/Service/Pod/node wiring, Ingress
  ...
  for the HPA control loop (desired replicas vs observed metric). These come
  straight from the System-design row plus `diagram-engine.md`'s topology /
  sequence / stack / curve archetypes.
