...
const COURSE_VISUAL = {
  archetype: "pipeline", title: "Personal Finance for Working Adults in three tracks",
  boxes: [
    { label: "Foundations: see and steer your money" },
    { label: "Core toolkit: debt, accounts, investing" },
    { label: "Put it together and stay safe" },
  ],
